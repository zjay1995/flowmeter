...
const uint8_t EEPROM_DEVICE_ID_OFFSET = 68;			//64 chars
const uint8_t EEPROM_WIFI_SSID_OFFSET = 132;		//32 chars
const uint8_t EEPROM_WIFI_PASSWORD_OFFSET = 164;	//32 chars
const uint8_t EEPROM_MQTT_SERVER_URL_OFFSET = 196;	//64 chars
const uint8_t EEPROM_FLASH_LOG_FREQ_OFFSET = 260;	//uint16_t
const uint8_t EEPROM_WIFI_RT_LOG_FREQ_OFFSET = 262;	//uint16_t
